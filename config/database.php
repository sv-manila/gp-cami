...
return [
    ...
    */
    ...
    'connections' => [
        ...
        // ---- gp-cami: the golden_profile hub (read/write, default) ----
        'golden_profile' => [
            'driver' => 'mysql',
            'url' => env('GP_DB_URL'),
            'host' => env('GP_DB_HOST', '127.0.0.1'),
            'port' => env('GP_DB_PORT', '3306'),
            'database' => env('GP_DB_DATABASE', 'golden_profile'),
            'username' => env('GP_DB_USERNAME', 'gp_engine'),
            'password' => env('GP_DB_PASSWORD', ''),
            'unix_socket' => env('GP_DB_SOCKET', ''),
            'charset' => 'utf8mb4',
        ...
        // ---- gp-cami: source, SELECT-only by grant; never written by the app ----
        'streamline_local' => [
            'driver' => 'mysql',
            'url' => env('SRC_DB_URL'),
            'host' => env('SRC_DB_HOST', '127.0.0.1'),
            'port' => env('SRC_DB_PORT', '3306'),
            'database' => env('SRC_DB_DATABASE', 'streamline_local'),
            'username' => env('SRC_DB_USERNAME', 'gp_source_ro'),
